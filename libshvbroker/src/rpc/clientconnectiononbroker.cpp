...
ClientConnectionOnBroker::ClientConnectionOnBroker(shv::iotqt::rpc::Socket *socket, const std::optional<AzureConfig>& azureConfig, QObject *parent)
	: Super(socket, azureConfig, parent)
{
