...
const std::vector<shv::chainpack::MetaMethod> PROPERTY_NODE_METHODS = {
	...
	{shv::chainpack::Rpc::METH_GET, shv::chainpack::MetaMethod::Flag::IsGetter, {}, "RpcValue", shv::chainpack::MetaMethod::AccessLevel::Read, {chainpack::MetaMethod::Signal{chainpack::Rpc::SIG_VAL_CHANGED}}},
