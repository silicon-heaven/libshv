...
const std::vector<shv::chainpack::MetaMethod> PROPERTY_NODE_METHODS = {
	...
	{shv::chainpack::Rpc::METH_GET, shv::chainpack::MetaMethod::Flag::IsGetter, "void", "ret", shv::chainpack::MetaMethod::AccessLevel::Read, {chainpack::MetaMethod::Signal{"chng"}}},
	{shv::chainpack::Rpc::METH_SET, shv::chainpack::MetaMethod::Flag::IsSetter, "void", "ret", shv::chainpack::MetaMethod::AccessLevel::Write},
};
