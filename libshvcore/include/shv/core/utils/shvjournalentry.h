...
public:
	...
	static ShvJournalEntry fromRpcValueList(const shv::chainpack::List &row, std::function< std::string (const chainpack::RpcValue &)> unmap_path = nullptr, std::string *err = nullptr);
