...
void append_log_entry(shv::chainpack::List& log, const ShvJournalEntry &e, GetLogContext& ctx)
{
...
exit_nested_loop:
	...
	auto snapshot_entries = [&] {
		...
		return shv::chainpack::List{};
	}();

	shv::chainpack::List result_entries = snapshot_entries;
